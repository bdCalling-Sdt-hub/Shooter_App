...
class UpComingEventsListView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      height: 260.h,
      child: Obx(() {
        return _homeController.eventLoading.value ? const CustomLoader() : _homeController.upComingEvensList.isEmpty? const Center(child: CustomText(text: "No data found!",),) :ListView.builder(
